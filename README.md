...
[中文文档](https://github.com/sllackking/bio-memory-os/blob/main/README_zh.md) | [文档](https://github.com/sllackking/bio-memory-os#-quick-install)
...
flowchart TD
    ...
    subgraph BMO Core Memory Layers
    ...
    class InputLayer,Enhancement Features,BMO Core Memory Layers,Output Layer subgraphStyle
```
